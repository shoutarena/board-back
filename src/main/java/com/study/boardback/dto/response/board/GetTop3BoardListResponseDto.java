...
public class GetTop3BoardListResponseDto extends ResponseDto {
    ...
    public GetTop3BoardListResponseDto(List<BoardListView> boardListViewEntities) {
        super(ResponseCode.SUCCESS.getCode(), ResponseCode.SUCCESS.getMessage());
        this.top3List = BoardList.getList(boardListViewEntities);
    }

    public static ResponseEntity<GetTop3BoardListResponseDto> success(List<BoardListView> boardListViewEntities){
