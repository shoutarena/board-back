...
public class GetLatestBoardListResponseDto extends ResponseDto {
    ...
    public GetLatestBoardListResponseDto(List<BoardListView> boardListViewEntities) {
    ...
    public static ResponseEntity<GetLatestBoardListResponseDto> success(List<BoardListView> boardListViewEntities){
